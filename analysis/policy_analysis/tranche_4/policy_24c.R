...
write_xlsx(path = "outputs/policy_24c/policy_24c_300_1_adult_england.xlsx", x = bmi_change_year)
# write_xlsx(path = "outputs/policy_21/policy_21_scotland.xlsx", x = table_outputs)
...
write.csv(post_df_adult, file = "outputs/policy_24c/policy_24c_300_adult_england_bmi.csv")
