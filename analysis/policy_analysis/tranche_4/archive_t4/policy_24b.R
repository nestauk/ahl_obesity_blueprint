...
################################################################################################### 
# Policy24b : Extend access to pharmacological interventions by providing an extra £500 million   #
...
write.csv(bmi_change_year, file = "outputs/policy_24b/policy_24b_5_adult_england.csv")
...
ggsave(here("outputs/policy_24b/policy_24b_impact_England_adult.png"), 
       plot = adult_bar_plot, 
       width = 10, 
       height = 6,
       bg='#ffffff')
