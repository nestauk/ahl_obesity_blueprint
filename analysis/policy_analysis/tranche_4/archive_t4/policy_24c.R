...
################################################################################################### 
# Policy24c : Extend access to pharmacological interventions by providing an extra £500 million   #
...
(sum(df$wt_int[df$eligibility == 1])/sum(df$wt_int)) * 44263393
...
# 
# df_1 = df_1 %>%
#   mutate(intervention_year3 = "No",
#          intervention_year4 = "No",
#          intervention_year5 = "No")

post_df_adult = assign_weight_changes(data = df_1, bodyweight_var = "weight", num_years = 5, weight_loss_percent = 0.0846, weight_regain = 0.67)
...
# write.csv(bmi_change_year, file = "outputs/policy_24c/policy_24c_5_adult_england.csv")


write_xlsx(path = "outputs/policy_24c/policy_24c_8_adult_england.xlsx", x = bmi_change_year)
...
ggsave(here("outputs/policy_24c/policy_24c_impact_England_adult.png"), 
       plot = adult_bar_plot, 
       width = 10, 
       height = 6,
       bg='#ffffff')
...
write.csv(post_df_adult, file = "outputs/policy_24c/policy_24c_adult_england_bmi.csv")
...
write_xlsx(path = "outputs/policy_24c/policy_24c_350_1_adult_england.xlsx", x = bmi_change_year)
# write_xlsx(path = "outputs/policy_21/policy_21_scotland.xlsx", x = table_outputs)
...
write.csv(post_df_adult, file = "outputs/policy_24c/policy_24c_350_1_adult_england_bmi.csv")
