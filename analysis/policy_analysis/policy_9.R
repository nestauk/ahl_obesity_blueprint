...
policy_9_impact_scotland_child = calculate_bmi_from_eichange_hox(df = read_csv(here("inputs/processed/shes_2019_children.csv")),
                                                                 daily_ei_change = 36.58,
                                                                 nation = "Scotland",
                                                                 tags = "Policy 9")
...
# 4.3. Outputs
# Bar plot of change in year on year distribution of different BMI categories
policy_9_impact_scotland_child$bmi_prevalence_plot

ggsave(here("outputs/policy_9/policy_9_impact_Scotland_child.png"), 
       plot = policy_9_impact_scotland_child$bmi_prevalence_plot, 
       width = 10, 
       height = 6,
       bg='#ffffff')
