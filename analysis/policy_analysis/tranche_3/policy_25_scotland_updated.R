...
ggsave(here("outputs/policy_25/policy_25_updated_impact_Scotland_Adult.png"), 
       plot = adult_bar_plot, 
       width = 10, 
       height = 6,
       bg='#ffffff')

write.csv(post_df_adult, file = "outputs/policy_25/policy_25_updated_adult_scotland_bmi.csv")


# bmi year on year prevalence:
# write.csv(bmi_change_year, file = "outputs/policy_25/policy_25_adult_scotland.csv")


write_xlsx(x = bmi_change_year, path = "outputs/policy_25/policy_25_updated_adult_scotland.xlsx")
