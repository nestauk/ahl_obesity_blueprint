...
post_df_adult = assign_weight_changes(data = df, bodyweight_var = "weight", num_years = 5, weight_loss_percent = 0.11, weight_regain = 0.67)
...
write.csv(bmi_change_year, file = "outputs/policy_24/policy_24_iter_1_adult_england.csv")
...
ggsave(here("outputs/policy_24/policy_24_updated_impact_England_adult.png"), 
       plot = adult_bar_plot, 
       width = 10, 
       height = 6,
       bg='#ffffff')
...
write.csv(post_df_adult, file = "outputs/policy_24/policy_24_updated_adult_england_bmi.csv")
