...
# Number of people the funding can reach = £500 million/£2,440 = 148,810 individuals
...
write.csv(bmi_change_year, file = "outputs/policy_24_2/policy_24_2_updated_adult_england.csv")
...
ggsave(here("outputs/policy_24_2/policy_24_2_updated_impact_England_adult.png"), 
       plot = adult_bar_plot, 
       width = 10, 
       height = 6,
       bg='#ffffff')
...
write.csv(post_df_adult, file = "outputs/policy_24_2/policy_24_2_updated_adult_england_bmi.csv")
