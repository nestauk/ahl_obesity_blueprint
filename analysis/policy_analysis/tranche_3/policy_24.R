...
# form of bariatric surgery will have a weight loss of 23%.
...
post_df_adult = assign_weight_changes(data = df, bodyweight_var = "weight", num_years = 5, weight_loss_percent = 0.23, weight_regain = 0.67)
