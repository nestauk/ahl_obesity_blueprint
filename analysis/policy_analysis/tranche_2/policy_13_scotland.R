...
# This script is specific to Scotland
...
ggsave(here("outputs/policy_13/policy_13_impact_scotland_child.png"), 
       plot = child_bar_plot, 
       width = 10, 
       height = 6,
       bg='#ffffff')
...
write_xlsx(path = "outputs/policy_13/policy_13_scotland.xlsx", x = child_bmi_change_year)
