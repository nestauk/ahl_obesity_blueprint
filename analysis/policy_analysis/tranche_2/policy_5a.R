...
policy_5a_impact_england_adult$bmi_category_plot

ggsave(here("outputs/policy_5a/policy_5a_impact_England_adult.png"), 
       plot = policy_5a_impact_england_adult$bmi_category_plot, 
       width = 10, 
       height = 6,
       bg='#ffffff')
...
# 3.3. Outputs
# Bar plot of change in year on year distribution of different BMI categories
policy_5a_impact_scotland_adult$bmi_category_plot

ggsave(here("outputs/policy_5a/policy_5a_impact_Scotland_adult.png"), 
       plot = policy_5a_impact_scotland_adult$bmi_category_plot, 
       width = 10, 
       height = 6,
       bg='#ffffff')
...
# Output table with year on year distrubution of BMI categories
policy_5a_impact_scotland_adult$bmi_percent_prevalence

table_outputs[["scotland_adult"]] = policy_5a_impact_scotland_adult$bmi_percent_prevalence
