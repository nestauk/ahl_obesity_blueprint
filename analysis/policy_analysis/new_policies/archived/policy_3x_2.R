...
# weight regain: 1.2 kg at the end of 3 years => 1.2/2 kg in second and third year
...
assign_weight_changes_1 <- function(data, bodyweight_var, num_years, weight_loss_1, weight_loss_2, weight_regain) {
  browser()
...
post_df_adult_1 = assign_weight_changes_1(data = df_selected, bodyweight_var = "weight",
                                      num_years = 5, weight_loss_1 = 2.4,
                                      weight_loss_2 = 0, weight_regain = 0.5*1.2)


post_df_adult_1 = post_df_adult_1 %>%
