...
# Updates:
# - Orlistat has been dropped --> the effect size has been updated weight loss is 11.1%
# - 100% of weight loss occurs in the first year on the drug, no weight change in year two
# - Weight gain @ two-thirds of the weight loss in third year then body weight plateaus
...
# Therefore, assuming that individuals are on the drugs for a period of 2 years: cost per person for 2 years = £3,360
# Number of people the ring-fenced funding can reach = £500 million/£3,360 = 148,810 individuals
