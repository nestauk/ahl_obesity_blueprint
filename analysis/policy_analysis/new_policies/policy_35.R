...
# (quality assured by the EAG) showed that the interventions led to a reduction of ~54 kcals in daily
...
# Inputs to the model:
# Effect size [A]: ﹣54 kcal
# Population segment impacted by policy [B]: Adults with BMI ≥ 25
# Compensation effect [C]: 23% of [A] = 12.42
# Duration [D]: 5 years ~ 365 * 5 days

# Based on [A] and [C], the intake change = effect size - compensation effect = -41.5 kcals
