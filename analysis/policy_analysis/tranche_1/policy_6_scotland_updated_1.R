...
write.csv(bmi_change_year, file = "outputs/policy_6/policy_6_updated_1_adult_scotland.csv")
...
ggsave(here("outputs/policy_6/policy_6_updated_1_impact_Scotland_adult.png"), 
       plot = adult_bar_plot, 
       width = 10, 
       height = 6,
       bg='#ffffff')
...
write.csv(post_df_adult, file = "outputs/policy_6/policy_6_updated_1_adult_scotland_bmi.csv")
