...
df <- perform_analysis(df = read_csv(here("inputs/processed/shes_2019.csv")))
...
write_xlsx(path = "outputs/policy_6/policy6_scotland_yearwise_bmi.xlsx", x = post_df_adult)
...
adult_bar_plot
ggsave(here("outputs/policy_6/policy_6_impact_Scotland_adult.png"), plot = adult_bar_plot, width = 10, height = 6, bg='#ffffff')
...
write_xlsx(path = "outputs/policy_6/policy_6_scotland.xlsx", x = bmi_change_year)
