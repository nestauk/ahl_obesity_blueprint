...
policy_1_2_impact_england_adult = calculate_bmi_from_eichange(df = read_csv(here("inputs/processed/hse_2019.csv")),
                                                            intake_change = -45.89,
                                                            implmentation_duration = 365*5)
# 1.3. Outputs

# Bar plot of change in year on year distribution of different BMI categories
policy_1_2_impact_england_adult$bmi_category_plot


# Output table with year on year distrubution of BMI categories
policy_1_2_impact_england_adult$bmi_percent_prevalence

table_outputs[["england_adult"]] = policy_1_2_impact_england_adult$bmi_percent_prevalence
...
policy_1_2_impact_scotland_adult = calculate_bmi_from_eichange(df = read_csv(here("inputs/processed/shes_2019.csv")),
                                                             intake_change = -45.89,
                                                             implmentation_duration = 365*5)
# 2.3. Outputs
# Bar plot of change in year on year distribution of different BMI categories
policy_1_2_impact_scotland_adult$bmi_category_plot

ggsave(here("outputs/policy_1_2/policy_1_2_impact_Scotland_adult.png"), 
       plot = policy_1_2_impact_scotland_adult$bmi_category_plot, 
       width = 10, 
       height = 6,
       bg='#ffffff')
...
# Output table with year on year distrubution of BMI categories
policy_1_2_impact_scotland_adult$bmi_percent_prevalence

table_outputs[["scotland_adult"]] = policy_1_2_impact_scotland_adult$bmi_percent_prevalence


write_xlsx(path = "outputs/policy_1_2/policy_1_2.xlsx", 
           x = table_outputs)




write.csv(policy_1_2_impact_england_adult$post_df, file = "outputs/policy_1_2/policy_1_2_adult_england_bmi.csv")

write.csv(policy_1_2_impact_scotland_adult$post_df, file = "outputs/policy_1_2/policy_1_2_adult_scotland_bmi.csv")
