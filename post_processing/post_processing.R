...
extract_pound_benefit_by_class = function(data, cost_30_40, cost_over_40, duration ){
  # browser()
  data_df = data
  ...
  # print(paste0("Average annual value to government compared to baseline = £", round(total_average_annual_benefit, 2), "billions"))
